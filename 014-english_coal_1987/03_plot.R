...
# graph ----
map_title <- "<span style='font-size:24pt'>FIGURATIVE MAP of *ENGLISH COAL EXPORTS in 1987*</span>"
...
ggsave(paste0("014-english_coal_",idf,".png"),width = w,height = h,dpi = 300)
...
ggsave(paste0("014-english_coal_smoothed_",idf,".png"),width = w,height = h,dpi = 300)
